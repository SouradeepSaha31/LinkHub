  ...
  useEffect(() => {
    ...
    const fetchdata = async () => {
      try {
        ...
        const response = await axios.get("/api/v1/savepost/showloggedinuserpostsave")
...

            {
              ...
              <div className="w-full min-h-[50px] pt-3 pb-2 border-b-[1px] border-zinc-700 flex flex-col items-start justify-start gap-1 ">
                <div className="flex items-center justify-between gap-3 w-full">
                  ...
                  <div>
                  <TbLibraryPlus onClick={() => unsavepost(post.postId)} className="text-green-600 text-[25px] cursor-pointer"/>
                  </div>
                </div>
                <h1 className="text-white text-[18px] font-semibold">
...
export default ProfileAllSavePost